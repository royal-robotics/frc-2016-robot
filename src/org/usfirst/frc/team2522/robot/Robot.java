<<<<<<< Upstream, based on branch 'master' of https://github.com/royal-robotics/frc-2016-robot.git
...
public class Robot extends IterativeRobot
{
	...
	Image binaryFrame;
	Image particalFrame;
	NIVision.Range REFLECTIVE_RED_RANGE = new NIVision.Range(0, 245);
	NIVision.Range REFLECTIVE_GREEN_RANGE = new NIVision.Range(250, 255);
	NIVision.Range REFLECTIVE_BLUE_RANGE = new NIVision.Range(0, 255);
	NIVision.ParticleFilterCriteria2 criteria[] = new NIVision.ParticleFilterCriteria2[1];
	NIVision.ParticleFilterOptions2 filterOptions = new NIVision.ParticleFilterOptions2(0,0,1,1);
...
//        accel = new FRCAccl(SPI.Port.kOnboardCS1, Accelerometer.Range.k4G);
    ...
    public void teleopPeriodic()
    {
    	...
    	else if (rightstick.getRawButton(OperatorController._AROUND_LEFT_BUTTON))
    	{
    		if (!turnAroundToggle)
    		{
    			resetBearing();
...
>>>>>>> c77697e Push changes from Hawaii Regional.
}