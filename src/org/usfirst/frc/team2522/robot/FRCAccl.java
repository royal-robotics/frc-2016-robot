...
public class FRCAccl extends SensorBase implements Accelerometer, LiveWindowSendable 
{
	/*----------------------------------------------------------------------------*/
	...
	/*----------------------------------------------------------------------------*/
	   ...
	   */
	  public FRCAccl(SPI.Port port, Range range) {
	    m_spi = new SPI(port);
	    init(range);
	  ...
	  @Override
	  public double getX() {
	    return getAcceleration(ADXL345_SPI.Axes.kX);
	  }

	  /** {@inheritDoc} */
	  @Override
	  public double getY() {
	    return getAcceleration(ADXL345_SPI.Axes.kY);
	  }

	  /** {@inheritDoc} */
	  @Override
	  public double getZ() {
	    return getAcceleration(ADXL345_SPI.Axes.kZ);
	  }
